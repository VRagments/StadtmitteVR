...
namespace VRStandardAssets.Utils
{
    ...
    public class OnHoverRadial : MonoBehaviour
    {
        ...
        // Reference to the VRInput so that input events can be subscribed to.


        private Coroutine m_SelectionFillRoutine;
        // Used to start and stop the filling coroutine based on input.
        private bool m_IsOnHoverRadialActive;
        ...
        private IEnumerator FillOnHoverRadial ()
        {
        ...
        public IEnumerator WaitForOnHoverRadialToFill ()
        {
        ...
        private void HandleOver ()
        {
            ...
            if (m_IsOnHoverRadialActive)
            {
                m_SelectionFillRoutine = StartCoroutine (FillOnHoverRadial ());
            }
        }
